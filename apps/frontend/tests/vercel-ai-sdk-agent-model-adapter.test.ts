...
test('vercel ai sdk agent model adapter delegates assistant reply to generateText', async () => {
  ...
  assert.match(calls[0].system ?? '', /runSimulation/)
  assert.match(calls[0].system ?? '', /sku_1/)
  assert.match(calls[0].messages?.at(-1)?.content ?? '', /帮我分析这个 SKU/)
})

test('vercel ai sdk agent model adapter prefetches selected workbench entity detail', async () => {
  ...
  const adapter = new VercelAiSdkAgentModelAdapter({
    ...
    generateText: (async (input: { messages?: Array<{ content?: string }> }) => {
      assert.match(input.messages?.at(-1)?.content ?? '', /getReportDetail/)
      assert.match(input.messages?.at(-1)?.content ?? '', /report_1/)
      return {
        text: '已基于当前报告详情回答',
        usage: { inputTokens: 10, outputTokens: 8, totalTokens: 18 },
        totalUsage: { inputTokens: 10, outputTokens: 8, totalTokens: 18 },
        finishReason: 'stop',
        response: { id: 'response_selected_entity_prefetch' },
        providerMetadata: {},
      }
    }) as never,
  })
  ...
  const result = await adapter.complete({
    session: { id: 'session_1', sessionKey: 's', userId: null, surface: 'agent-copilot', piSessionKey: null, piSessionRef: null, title: null, status: 'ACTIVE', configJson: {}, lastActiveAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    mission: { id: 'mission_1', sessionId: 'session_1', missionType: 'goal_driven', objective: '解释报告', autonomyLevel: 'review_required', status: 'ACTIVE', sourceSurface: 'agent-copilot', subjectType: 'report', subjectId: 'report_1', constraintsJson: {}, workbenchContextJson: {}, planJson: {}, nextActionsJson: {}, createdBy: null, completedAt: null, canceledAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    run: { id: 'run_1', missionId: 'mission_1', sessionId: 'session_1', piRunId: null, workflowRunId: null, status: 'RUNNING', modelProvider: 'vercel-ai-sdk', modelName: 'test-model', inputJson: {}, outputJson: {}, errorMessage: null, timeoutMs: null, cancelRequested: false, usageJson: {}, metadataJson: {}, startedAt: '2026-05-24T00:00:00.000Z', completedAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    messages: [{ id: 'message_1', sessionId: 'session_1', runId: 'run_1', role: 'user', orderIndex: 1, contentText: '解释当前报告的风险和下一步', contentJson: {}, status: 'completed', parentId: null, createdAt: '2026-05-24T00:00:00.000Z' }],
    context: { route: '/report-center', selectedEntity: { entityType: 'report', entityId: 'report_1', label: '报告 1' } },
    executeTool: async (input) => {
      ...
      return {
        ...
        status: 'SUCCEEDED',
        summary: '读取报告详情：报告 1',
        data: { reportId: 'report_1', title: '报告 1' },
        evidenceRefs: [],
        linkedEntities: [],
        reviewGate: null,
      }
  ...
  assert.equal(result.content, '已基于当前报告详情回答')
  assert.deepEqual(executedTools.map((item) => item.toolName), ['getDashboardContext', 'getReportDetail'])
...
test('vercel ai sdk agent model adapter prefetches selected report version detail', async () => {
  ...
  const adapter = new VercelAiSdkAgentModelAdapter({
    ...
    model: { specificationVersion: 'v2', provider: 'test', modelId: 'test-model' } as never,
    generateText: (async (input: { messages?: Array<{ content?: string }> }) => {
      assert.match(input.messages?.at(-1)?.content ?? '', /getReportVersion/)
      assert.match(input.messages?.at(-1)?.content ?? '', /version_2/)
      return {
        text: '已基于当前报告版本回答',
        usage: { inputTokens: 10, outputTokens: 8, totalTokens: 18 },
        totalUsage: { inputTokens: 10, outputTokens: 8, totalTokens: 18 },
        finishReason: 'stop',
        response: { id: 'response_selected_report_version_prefetch' },
        providerMetadata: {},
      }
    }) as never,
  })
  ...
  const result = await adapter.complete({
    session: { id: 'session_1', sessionKey: 's', userId: null, surface: 'agent-copilot', piSessionKey: null, piSessionRef: null, title: null, status: 'ACTIVE', configJson: {}, lastActiveAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    mission: { id: 'mission_1', sessionId: 'session_1', missionType: 'goal_driven', objective: '解释报告版本', autonomyLevel: 'review_required', status: 'ACTIVE', sourceSurface: 'agent-copilot', subjectType: 'report', subjectId: 'report_1', constraintsJson: {}, workbenchContextJson: {}, planJson: {}, nextActionsJson: {}, createdBy: null, completedAt: null, canceledAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    run: { id: 'run_1', missionId: 'mission_1', sessionId: 'session_1', piRunId: null, workflowRunId: null, status: 'RUNNING', modelProvider: 'vercel-ai-sdk', modelName: 'test-model', inputJson: {}, outputJson: {}, errorMessage: null, timeoutMs: null, cancelRequested: false, usageJson: {}, metadataJson: {}, startedAt: '2026-05-24T00:00:00.000Z', completedAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    messages: [{ id: 'message_1', sessionId: 'session_1', runId: 'run_1', role: 'user', orderIndex: 1, contentText: '解释当前报告版本', contentJson: {}, status: 'completed', parentId: null, createdAt: '2026-05-24T00:00:00.000Z' }],
    context: { route: '/report-center', selectedEntity: { entityType: 'report', entityId: 'report_1', label: '报告 1' }, visibleFilters: { selectedVersionId: 'version_2' } },
    executeTool: async (input) => {
      executedTools.push({ toolName: input.toolName, inputJson: input.inputJson })
      return {
        toolCall: { id: `tool_${executedTools.length}`, runId: input.run.id, externalToolCallId: null, workflowStepId: null, toolName: input.toolName, status: 'SUCCEEDED', riskLevel: 'L1', reviewPolicy: 'AUTO_ALLOW', inputJson: input.inputJson, outputJson: {}, evidenceRefsJson: {}, errorMessage: null, blockedReason: null, startedAt: '2026-05-24T00:00:00.000Z', completedAt: '2026-05-24T00:00:00.000Z', createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
        status: 'SUCCEEDED',
        summary: input.toolName === 'getReportVersion' ? '读取报告版本：v2' : '读取报告详情：报告 1',
        data: input.inputJson,
        evidenceRefs: [],
        linkedEntities: [],
        reviewGate: null,
  ...
  assert.equal(result.content, '已基于当前报告版本回答')
  assert.deepEqual(executedTools.map((item) => item.toolName), ['getReportDetail', 'getReportVersion'])
...
test('vercel ai sdk agent model adapter prefetches selected agent mission detail', async () => {
  ...
  const adapter = new VercelAiSdkAgentModelAdapter({
    ...
    model: { specificationVersion: 'v2', provider: 'test', modelId: 'test-model' } as never,
    generateText: (async (input: { messages?: Array<{ content?: string }> }) => {
      assert.match(input.messages?.at(-1)?.content ?? '', /getAgentMission/)
      assert.match(input.messages?.at(-1)?.content ?? '', /mission_1/)
      return {
        text: '已基于当前 Mission 详情回答',
        usage: { inputTokens: 10, outputTokens: 8, totalTokens: 18 },
        totalUsage: { inputTokens: 10, outputTokens: 8, totalTokens: 18 },
        finishReason: 'stop',
        response: { id: 'response_agent_mission_prefetch' },
        providerMetadata: {},
      }
    }) as never,
  })
  ...
  const result = await adapter.complete({
    session: { id: 'session_1', sessionKey: 's', userId: null, surface: 'agent-copilot', piSessionKey: null, piSessionRef: null, title: null, status: 'ACTIVE', configJson: {}, lastActiveAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    mission: { id: 'mission_1', sessionId: 'session_1', missionType: 'goal_driven', objective: '检查任务状态', autonomyLevel: 'review_required', status: 'ACTIVE', sourceSurface: 'agent-copilot', subjectType: 'activity_rule_set', subjectId: 'tmall-618', constraintsJson: {}, workbenchContextJson: {}, planJson: {}, nextActionsJson: {}, createdBy: null, completedAt: null, canceledAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    run: { id: 'run_1', missionId: 'mission_1', sessionId: 'session_1', piRunId: null, workflowRunId: null, status: 'RUNNING', modelProvider: 'vercel-ai-sdk', modelName: 'test-model', inputJson: {}, outputJson: {}, errorMessage: null, timeoutMs: null, cancelRequested: false, usageJson: {}, metadataJson: {}, startedAt: '2026-05-24T00:00:00.000Z', completedAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    messages: [{ id: 'message_1', sessionId: 'session_1', runId: 'run_1', role: 'user', orderIndex: 1, contentText: '当前任务进展怎么样', contentJson: {}, status: 'completed', parentId: null, createdAt: '2026-05-24T00:00:00.000Z' }],
    context: { route: '/agent-mission', selectedEntity: { entityType: 'agentMission', entityId: 'mission_1', label: '任务 1' } },
    executeTool: async (input) => {
      executedTools.push({ toolName: input.toolName, inputJson: input.inputJson })
      return {
        toolCall: { id: `tool_${executedTools.length}`, runId: input.run.id, externalToolCallId: null, workflowStepId: null, toolName: input.toolName, status: 'SUCCEEDED', riskLevel: 'L1', reviewPolicy: 'AUTO_ALLOW', inputJson: input.inputJson, outputJson: {}, evidenceRefsJson: {}, errorMessage: null, blockedReason: null, startedAt: '2026-05-24T00:00:00.000Z', completedAt: '2026-05-24T00:00:00.000Z', createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
        status: 'SUCCEEDED',
        summary: '读取任务详情：任务 1',
        data: { missionId: 'mission_1', objective: '检查任务状态' },
        evidenceRefs: [],
        linkedEntities: [],
        reviewGate: null,
      }
  ...
  assert.equal(result.content, '已基于当前 Mission 详情回答')
  assert.deepEqual(executedTools.map((item) => item.toolName), ['getDashboardContext', 'getAgentMission'])
  assert.deepEqual(executedTools.find((item) => item.toolName === 'getAgentMission')?.inputJson, { missionId: 'mission_1' })
})

test('vercel ai sdk agent model adapter prefetches selected agent mission run detail', async () => {
  const executedTools: Array<{ toolName: string; inputJson: Record<string, unknown> }> = []
  const adapter = new VercelAiSdkAgentModelAdapter({
    apiKey: 'test-key',
    modelName: 'test-model',
    ...
    generateText: (async (input: { messages?: Array<{ content?: string }> }) => {
      assert.match(input.messages?.at(-1)?.content ?? '', /getAgentMission/)
      assert.match(input.messages?.at(-1)?.content ?? '', /getAgentRunDetail/)
      assert.match(input.messages?.at(-1)?.content ?? '', /run_42/)
      return {
        text: '已基于当前 Mission Run 详情回答',
        usage: { inputTokens: 10, outputTokens: 8, totalTokens: 18 },
        totalUsage: { inputTokens: 10, outputTokens: 8, totalTokens: 18 },
        finishReason: 'stop',
        response: { id: 'response_agent_mission_run_prefetch' },
        providerMetadata: {},
      }
    }) as never,
  })
  ...
  const result = await adapter.complete({
    session: { id: 'session_1', sessionKey: 's', userId: null, surface: 'agent-copilot', piSessionKey: null, piSessionRef: null, title: null, status: 'ACTIVE', configJson: {}, lastActiveAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    mission: { id: 'mission_1', sessionId: 'session_1', missionType: 'goal_driven', objective: '检查任务运行', autonomyLevel: 'review_required', status: 'ACTIVE', sourceSurface: 'agent-copilot', subjectType: 'activity_rule_set', subjectId: 'tmall-618', constraintsJson: {}, workbenchContextJson: {}, planJson: {}, nextActionsJson: {}, createdBy: null, completedAt: null, canceledAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    run: { id: 'run_1', missionId: 'mission_1', sessionId: 'session_1', piRunId: null, workflowRunId: null, status: 'RUNNING', modelProvider: 'vercel-ai-sdk', modelName: 'test-model', inputJson: {}, outputJson: {}, errorMessage: null, timeoutMs: null, cancelRequested: false, usageJson: {}, metadataJson: {}, startedAt: '2026-05-24T00:00:00.000Z', completedAt: null, createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
    messages: [{ id: 'message_1', sessionId: 'session_1', runId: 'run_1', role: 'user', orderIndex: 1, contentText: '当前工具调用和 Review Gate 怎么样', contentJson: {}, status: 'completed', parentId: null, createdAt: '2026-05-24T00:00:00.000Z' }],
    context: { route: '/agent-mission', selectedEntity: { entityType: 'agentMission', entityId: 'mission_1', label: '任务 1' }, visibleFilters: { runId: 'run_42' } },
    executeTool: async (input) => {
      executedTools.push({ toolName: input.toolName, inputJson: input.inputJson })
      return {
        toolCall: { id: `tool_${executedTools.length}`, runId: input.run.id, externalToolCallId: null, workflowStepId: null, toolName: input.toolName, status: 'SUCCEEDED', riskLevel: 'L1', reviewPolicy: 'AUTO_ALLOW', inputJson: input.inputJson, outputJson: {}, evidenceRefsJson: {}, errorMessage: null, blockedReason: null, startedAt: '2026-05-24T00:00:00.000Z', completedAt: '2026-05-24T00:00:00.000Z', createdAt: '2026-05-24T00:00:00.000Z', updatedAt: '2026-05-24T00:00:00.000Z' },
        status: 'SUCCEEDED',
        summary: input.toolName === 'getAgentRunDetail' ? '读取 Agent Run：run_42' : '读取 Agent Mission：mission_1',
        data: input.inputJson,
        evidenceRefs: [],
        linkedEntities: [],
        reviewGate: null,
  ...
  assert.equal(result.content, '已基于当前 Mission Run 详情回答')
  assert.deepEqual(executedTools.map((item) => item.toolName), ['getDashboardContext', 'getAgentMission', 'getAgentRunDetail'])
  assert.deepEqual(executedTools.find((item) => item.toolName === 'getAgentMission')?.inputJson, { missionId: 'mission_1' })
  assert.deepEqual(executedTools.find((item) => item.toolName === 'getAgentRunDetail')?.inputJson, { runId: 'run_42' })
})
...
test('vercel ai sdk agent model adapter exposes system operation tools', async () => {
  ...
  const adapter = new VercelAiSdkAgentModelAdapter({
    ...
    generateText: (async (input: { tools?: Record<string, { inputSchema?: unknown; execute?: (input: unknown) => Promise<unknown> }> }) => {
      ...
      await input.tools?.updateConnectorPermissions?.execute?.({ connectorId: 'connector_1', permissions: ['read_product', 'write_product'] })
      ...
      await input.tools?.runSimulation?.execute?.({ ruleSetId: 'rule_1', skuProfileIds: ['sku_1'] })
      await input.tools?.startActivityRun?.execute?.({ activityId: 'activity_1' })
      await input.tools?.addActivityCandidateSkus?.execute?.({ activityId: 'activity_1', skuProfileIds: ['sku_1'], comment: '加入候选清单' })
