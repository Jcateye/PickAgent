...
export const mockReviewItems: ReviewItemDto[] = [
  {
    ...
    evidenceSummary: [
      { id: 'EV-1', label: '活动库存门槛', value: '>= 120 件', source: 'ActivityRuleSet' },
      { id: 'EV-2', label: '当前可售库存', value: '86 件', source: 'CurrentSkuProjection' },
      { id: 'EV-3', label: '近 30 日销量', value: '143 件', source: 'ActivitySimulationResult' }
    ],
  ...
  },
  {
    ...
    evidenceSummary: [
      { id: 'EV-4', label: '证书编号', value: '缺失', source: 'SkuSnapshot' },
      { id: 'EV-5', label: '类目规则', value: '钻石戒指必须提供证书编号', source: 'SkuHealthDiagnosis' }
    ],
  ...
  },
  {
    ...
    evidenceSummary: [
      { id: 'EV-6', label: 'Direct Ready SKU', value: '42 个', source: 'ActivitySimulationRun' },
      { id: 'EV-7', label: '高风险 SKU', value: '0 个', source: 'AgentReviewGate' }
    ],
