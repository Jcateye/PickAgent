    ...
    <div className="pageStack">
      <div className="pageHeader" style={{ paddingBottom: '16px', borderBottom: '1px solid var(--line)' }}>
        ...
        <div className={styles.headerActions}>
          <button className="primaryButton" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <Play size={16} /> 运行检查
          </button>
          <button className="secondaryButton" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <div className="twoColumnMain" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div className="panel">
            <div className={styles.sectionHeader}>
              ...
              <a href="#" style={{ color: 'var(--primary)', fontSize: '13px' }}>查看完整规则 ↗</a>
            </div>
          ...
          <div className="panel">
            ...
            <table className={styles.dataTable}>
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="#" style={{ color: 'var(--primary)' }}>查看证据 ↗</a></td>
                </tr>
                <tr>
                  <td>R618-002</td>
                  <td>好评率</td>
            ...
            <div style={{ padding: '12px 16px', borderTop: '1px solid var(--line)', display: 'flex', justifyContent: 'space-between', fontSize: '13px', color: 'var(--muted)' }}>
              <span>共 5 条</span>
              <a href="#" style={{ color: 'var(--muted)' }}>置信度说明 ⓘ</a>
            </div>
          </div>
          ...
          <div className="panel">
            <div className={styles.sectionHeader}>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <button className="secondaryButton" style={{ height: '32px', fontSize: '13px' }}>批量指派</button>
                <button className="secondaryButton" style={{ height: '32px', fontSize: '13px', display: 'flex', alignItems: 'center' }}>
                  <CheckSquare size={14} style={{ marginRight: '6px' }} /> 批量标记 ∨
                </button>
                <button className="iconButton" style={{ height: '32px', width: '32px' }}><RefreshCw size={14} /></button>
              </div>
            </div>
            <table className={styles.dataTable}>
              <thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="#" style={{ color: 'var(--primary)' }}>查看</a></td>
                </tr>
                <tr>
                  <td><input type="checkbox" /></td>
                ...
                <tr>
                  ...
                  <td><a href="#" style={{ color: 'var(--primary)' }}>补数</a></td>
                </tr>
                <tr>
                  <td><input type="checkbox" /></td>
                  ...
                  <td><div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}><div style={{width:'20px', height:'20px', background:'#eee', borderRadius:'50%'}}></div>运营同学</div></td>
                  <td><a href="#" style={{ color: 'var(--primary)' }}>确认</a></td>
                </tr>
                <tr>
                  <td><input type="checkbox" /></td>
        ...
        <div className="twoColumnSide" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div className="panel">
            <div className={styles.sectionHeader} style={{ padding: '16px 20px' }}>
              ...
              <a href="#" style={{ fontSize: '13px', color: 'var(--primary)' }}>查看全部</a>
            </div>
            <div className={styles.sectionBody}>
            ...
            <div className={styles.sectionBody}>
              <div className={styles.warningBox}>
                ...
                <div className={styles.warningContent}>
                  ...
                  <a href="#" style={{ fontSize: '12px', color: 'var(--primary)', alignSelf: 'flex-start' }}>查看</a>
                </div>
              </div>
              <div className={styles.warningBox}>
                <AlertTriangle size={16} className={styles.warningIcon} />
