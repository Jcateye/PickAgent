...
- [x] 1.1 定义 Mission、Run、Event、Gate 和 linked entity 的最小 contract
- [x] 1.2 实现 Agent Copilot 的消息流、Plan、Trace、Context 和 Review Gate 面板骨架

## 2. Mock-driven workbench flow

- [x] 2.1 用 mock message 和 mock event stream 打通 Mission 发起与继续流程
- [x] 2.2 用 mock tool result 打通 Trace、Linked Context 和 Evidence 展示

## 3. Gate and continuation flow

- [x] 3.1 实现 Review Gate 的暂停、查看和决策交互
- [x] 3.2 实现 Gate 决策后的继续执行或恢复流程
...
- [x] 5.1 用 mock event fixture 校验 Mission、消息流、Plan、Trace、Context、Evidence、Review Gate、暂停/继续路径
